...
public abstract class AbstractOpenSslTlsRegistryIT extends BaseVertX {
    ...
    @Test
    @Order(23)
    @Disabled("https://github.com/quarkusio/quarkus/issues/56774")
    ...
    // Server relaxed and groups X25519

    @Test
    @Order(51)
    void testRelaxedWithX25519AndClientX25519MLKEM768Only() {
        restartAppAndChangePqcProperties("relaxed", "X25519");
    ...
    @Test
    @Order(52)
    void testRelaxedWithX25519AndClientX25519Only() {
        sendRequest(List.of("X25519"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(53)
    void testRelaxedWithX25519AndClientSecP256r1MLKEM768Only() {
        sendRequestAndExpectFailure(List.of("SecP256r1MLKEM768"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(54)
    void testRelaxedWithX25519AndClientSecP384r1MLKEM1024Only() {
        sendRequestAndExpectFailure(List.of("SecP384r1MLKEM1024"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(55)
    void testRelaxedWithX25519AndClientSecP384r1MLKEM1024AndX25519() {
        sendRequest(List.of("SecP384r1MLKEM1024", "X25519"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    // Server relaxed and groups X25519MLKEM768 and X25519

    @Test
    @Order(56)
    void testRelaxedWithX25519MLKEM768AndX25519AndClientX25519MLKEM768Only() {
        restartAppAndChangePqcProperties("relaxed", "X25519MLKEM768,X25519");
    ...
    @Test
    @Order(57)
    void testRelaxedWithX25519MLKEM768AndX25519AndClientX25519Only() {
        sendRequest(List.of("X25519"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(58)
    void testRelaxedWithX25519MLKEM768AndX25519AndClientSecP256r1MLKEM768Only() {
        sendRequestAndExpectFailure(List.of("SecP256r1MLKEM768"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(59)
    void testRelaxedWithX25519MLKEM768AndX25519AndClientSecP384r1MLKEM1024Only() {
        sendRequestAndExpectFailure(List.of("SecP384r1MLKEM1024"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    @Test
    @Order(60)
    void testRelaxedWithX25519MLKEM768AndX25519AndClientSecP384r1MLKEM1024AndX25519() {
        sendRequest(List.of("SecP384r1MLKEM1024", "X25519"), app.getURI(Protocol.HTTPS) + "/hello", certificate);
    }

    // Test startup warning log when using relaxed with PQC algorithm
