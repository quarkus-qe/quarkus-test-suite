...
public class OpenSslNamedTlsRegistryPemIT extends AbstractOpenSslTlsRegistryIT {
    ...
    @QuarkusApplication(ssl = true, properties = "openssl-named.properties", certificates = @Certificate(configureKeystore = true, configureTruststore = true, configureHttpServer = true, format = Certificate.Format.PEM, tlsConfigName = TLS_CONFIG_NAME))
