...
public class OpenSslNamedTlsRegistryP12IT extends AbstractOpenSslTlsRegistryIT {
    ...
    @QuarkusApplication(ssl = true, properties = "openssl-named.properties", certificates = @Certificate(configureKeystore = true, configureTruststore = true, configureHttpServer = true, format = Certificate.Format.PKCS12, tlsConfigName = TLS_CONFIG_NAME))
