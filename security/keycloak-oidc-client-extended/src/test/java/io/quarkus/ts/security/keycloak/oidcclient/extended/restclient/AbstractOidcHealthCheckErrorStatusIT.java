...
public abstract class AbstractOidcHealthCheckErrorStatusIT {
    ...
    public void testHealthCheckOKBeforeStopping() {
        ...
        Assertions.assertNotNull(oidcCheck);
        assertEquals("OK", oidcCheck.getJsonObject("data").getString("Test Tenant"));
    }
    ...
    public void testErrorStatusWhenProviderStopped() {
        ...
        Assertions.assertNotNull(oidcCheck);
        String status = oidcCheck.getJsonObject("data").getString("Test Tenant");
