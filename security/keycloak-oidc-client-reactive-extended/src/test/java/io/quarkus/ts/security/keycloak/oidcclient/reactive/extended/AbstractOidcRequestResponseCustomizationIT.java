...
@QuarkusScenario
public class AbstractOidcRequestResponseCustomizationIT {
    ...
    static {
        ...
        wiremock.start();
        OidcWiremockTestHelper.setupOidc(wiremock);
    }
    ...
    static RestService app = new RestService()
            .withProperty("quarkus.oidc.auth-server-url",
                    () -> wiremock.baseUrl() + "/auth/realms/test-realm")
            .withProperty("quarkus.oidc.client-id", "test-client")
            .withProperty("quarkus.oidc.credentials.secret", "test-secret")
            .withProperty("quarkus.oidc-client.auth-server-url",
                    () -> wiremock.baseUrl() + "/auth/realms/test-realm")
            .withProperty("quarkus.oidc-client.client-id", "test-client")
            .withProperty("quarkus.http.auth.permission.all.paths", "/*")
            ...
            .withProperty("quarkus.oidc-client.credentials.secret", "test-secret");

    private void clearFilterLogs() {
