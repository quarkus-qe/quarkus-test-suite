...
import io.quarkus.ts.security.permissions.annotations.CanCreate;
import io.quarkus.ts.security.permissions.annotations.CanReadAll;
import io.quarkus.ts.security.permissions.annotations.CanReadAllAndCreate;
import io.quarkus.ts.security.permissions.annotations.CanReadAllAndCreateInclusive;
import io.quarkus.ts.security.permissions.annotations.CanReadAndUpdate;
import io.quarkus.ts.security.permissions.annotations.CanReadAndUpdateCustomPermission;
import io.quarkus.ts.security.permissions.annotations.CanReadAndUpdateCustomPermissionInclusive;
import io.quarkus.ts.security.permissions.annotations.CanReadAndUpdateInclusive;
