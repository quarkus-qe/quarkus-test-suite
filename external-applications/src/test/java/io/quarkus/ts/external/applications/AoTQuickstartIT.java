...
public class AoTQuickstartIT {
    ...
    @GitRepositoryQuarkusApplication(repo = "https://github.com/quarkusio/quarkus-quickstarts.git", contextDir = QUICKSTART_DIRECTORY, branch = "3.40", mavenArgs = AOT_PROPERTIES
