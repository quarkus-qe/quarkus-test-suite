...
public class TlsWebSocketIT extends BaseWebSocketIT {
    private static final String TRUST_STORE_FILENAME = "client-truststore.jks";
    ...
    private X509TrustManager generateTrustManager()
        ...
        InputStream myKeys = getClass().getClassLoader().getResourceAsStream(TRUST_STORE_FILENAME);
