...
public class MoviesIT {
    ...
    @GitRepositoryQuarkusApplication(repo = "https://github.com/quarkiverse/quarkus-langchain4j.git", branch = "1.7", contextDir = "samples/movie-similarity-search", mavenArgs = DEFAULT_ARGS
