...
```shell
mvn clean verify -Dall-modules -Dnative -Dquarkus.native.builder-image=quay.io/quarkus/ubi9-quarkus-mandrel-builder-image:jdk-25 -Dquarkus.native.native-image-xmx=5g -Dopenshift -pl http/http-minimum
```
