package io.quarkus.ts.buildtimeanalytics.utils;
...
public class AnalyticsUtils {
    ...
    // occasionally, in daily runs we got extensions with versions like 3.40.999-20260723.132749-19
    private static final String QUARKUS_EXTENSION_SNAPSHOT_VERSION_REGEX = "3\\.40\\.999-.*";
    ...
    private static String getExtensionVersionRegex() {
        ...
        if (version.endsWith(QUARKUS_SNAPSHOT_SUFFIX)) {
