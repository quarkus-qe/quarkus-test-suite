...
import io.quarkus.ts.http.advanced.reactive.json.FootballTeam;
import io.quarkus.ts.http.advanced.reactive.json.FootballTeamResource;
import io.quarkus.ts.http.advanced.reactive.json.JsonExceptionMapper;
import io.quarkus.ts.http.advanced.reactive.json.Person;
import io.quarkus.ts.http.advanced.reactive.json.PersonResource;
