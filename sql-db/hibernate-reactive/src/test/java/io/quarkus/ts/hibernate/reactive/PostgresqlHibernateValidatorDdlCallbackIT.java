...
@QuarkusScenario
@Tag("QUARKUS-6242")
public class PostgresqlHibernateValidatorDdlCallbackIT extends AbstractHibernateValidatorIT {
    ...
    static RestService app = new RestService()
            ...
            .withProperty("quarkus.hibernate-orm.validation.mode", "ddl,callback");
